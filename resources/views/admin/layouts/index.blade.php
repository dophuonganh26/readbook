    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ route('dashboard') }}">
                <div class="sidebar-brand-text" style="font-size: 17px;">Thích đọc truyện</div>
            </a>
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <img class="img-profile rounded-circle"
                                    src="{{ is_null(\App\Models\Admin::find(Auth::guard('admin')->user()->id)->avatar) ? asset('admin/img/undraw_profile.svg') : asset(\App\Models\Admin::find(Auth::guard('admin')->user()->id)->avatar) }}">
                            </a>
                            <!-- Dropdown - User Information -->
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                aria-labelledby="userDropdown">
                                <a class="dropdown-item" href="{{ route('admin.form.update.avatar') }}">
                                    <i class="fas fa-image fa-sm fa-fw mr-2 text-gray-400"></i>
                                    Cập nhật avatar
                                </a>
                                <a class="dropdown-item" href="{{ route('admin.form.update.password') }}">
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright {{ date('Y') }} - Hệ thống độc quyền của Đọc truyện online</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
